...
const getAllFromDB = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield store_model_1.Store.find(whereConditions)
        .sort(sortConditions)
        .skip(skip)
        .limit(limit)
        .populate("manager");
    const total = yield store_model_1.Store.countDocuments(whereConditions);
    return {
        meta: {
            page,
            limit,
...
const getByIdFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield store_model_1.Store.findById(id).populate("manager");
    return result;
});
const updateFromDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield store_model_1.Store.findById(id);
    if (!isExist) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Brand does not exist!");
    }
    const result = yield store_model_1.Store.findOneAndUpdate({ _id: id }, payload, {
        new: true,
    }).populate("manager");
    return result;
});
const deleteFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield store_model_1.Store.findOne({
        _id: id,
    });
    if (!isExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "Brand does not found !");
    }
    const result = yield store_model_1.Store.deleteOne({ _id: id }, {
        new: true,
    });
