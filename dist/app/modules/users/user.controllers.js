...
const insertIntoDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_services_1.UserService.insertIntoDB(userData);
    // Clone the result object
    const resultClone = Object.assign({}, result.toObject());
    // Remove the 'password' field from the clone
    const { password } = resultClone, others = __rest(resultClone, ["password"]);
...
const getAllUsers = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_services_1.UserService.getAllUsers(filters, paginationOptions);
    (0, sendResponse_1.default)(res, {
        statusCode: 400,
        success: true,
